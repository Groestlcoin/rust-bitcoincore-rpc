...
use groestlcoin::{Address, Amount, PrivateKey, PublicKey, SignedAmount, Transaction, ScriptBuf, Script, bip158, bip32, Network};
...
pub struct GetBlockStatsResult {
    ...
    pub block_hash: groestlcoin::BlockHash,
...
pub struct GetBlockStatsResultPartial {
    ...
    pub block_hash: Option<groestlcoin::BlockHash>,
...
pub struct GetMempoolInfoResult {
    ...
    #[serde(rename = "incrementalrelayfee", default, with = "groestlcoin::amount::serde::as_btc::opt")]
...
pub enum HashOrHeight {
    BlockHash(groestlcoin::BlockHash),
    Height(u64),
}
    ...
    impl<'de> serde::de::Visitor<'de> for NetworkVisitor {
        ...
        fn visit_str<E: serde::de::Error>(self, s: &str) -> Result<Self::Value, E> {
            Network::from_core_arg(s)
                .map_err(|_| E::invalid_value(serde::de::Unexpected::Str(s), &"groestlcoin network encoded as a string"))
        }

        fn expecting(&self, formatter: &mut fmt::Formatter) -> fmt::Result {
            write!(formatter, "groestlcoin network encoded as a string")
        }
    }
